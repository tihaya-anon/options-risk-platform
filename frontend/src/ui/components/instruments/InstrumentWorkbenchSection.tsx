...
import { formatNumber, formatStrike } from "@/ui/format";
        ...
        <article className="card dashboard-column-card">
          ...
          <div className="grouped-stats">
            ...
            <div>
              ...
              <strong>{selectedRow?.strike !== undefined ? formatStrike(selectedRow.strike) : t("none")}</strong>
            </div>
          </div>
        </article>
      </div>
        ...
        <article className="card dashboard-column-card">
          ...
          {selectedRow ? (
            <div className="greek-mini-grid">
              <GreekMetricCard greek="delta" value={formatNumber(selectedRow.delta ?? 0, 3)} t={t} />
              <GreekMetricCard greek="gamma" value={formatNumber(selectedRow.gamma ?? 0, 4)} t={t} />
              <GreekMetricCard greek="vega" value={formatNumber(selectedRow.vega ?? 0, 3)} t={t} />
              <GreekMetricCard greek="theta" value={formatNumber(selectedRow.theta ?? 0, 3)} t={t} />
            </div>
          ) : (
