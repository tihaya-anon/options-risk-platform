...
export const getTestProviderConnectionResponseMock = (overrideResponse: Partial< ProviderTestResponse > = {}): ProviderTestResponse => ({ok: faker.datatype.boolean(), provider: faker.string.alpha({length: {min: 10, max: 20}}), symbol: faker.string.alpha({length: {min: 10, max: 20}}), latencyMs: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), error: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), source: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), generatedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`, null]), undefined]), ...overrideResponse})
...
export const getCreateHedgeProposalsResponseMock = (overrideResponse: Partial< HedgeProposalResponse > = {}): HedgeProposalResponse => ({baselineExposure: {marketValue: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), grossExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), netExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), delta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), gamma: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), vega: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), theta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), beta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2})}, proposals: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha({length: {min: 10, max: 20}}), hedgeType: faker.helpers.arrayElement(Object.values(HedgeType)), label: faker.string.alpha({length: {min: 10, max: 20}}), summary: faker.string.alpha({length: {min: 10, max: 20}}), instrument: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), hedgeRatio: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), null]), undefined]), estimatedCost: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), null]), undefined]), residualExposure: {marketValue: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), grossExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), netExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), delta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), gamma: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), vega: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), theta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), beta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2})}, notes: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined]), rationale: faker.helpers.arrayElement([{why: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), tradeOffs: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), residualRisks: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))}, undefined])})), ...overrideResponse})

export const getCompareStrategiesResponseMock = (overrideResponse: Partial< StrategyComparison > = {}): StrategyComparison => ({baselineExposure: {marketValue: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), grossExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), netExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), delta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), gamma: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), vega: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), theta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), beta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2})}, rows: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({proposalId: faker.string.alpha({length: {min: 10, max: 20}}), label: faker.string.alpha({length: {min: 10, max: 20}}), estimatedCost: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), residualExposure: {marketValue: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), grossExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), netExposure: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), delta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), gamma: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), vega: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), theta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), beta: faker.number.float({min: undefined, max: undefined, fractionDigits: 2})}, upsideRetention: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), null]), undefined]), downsideProtection: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), null]), undefined]), carryTheta: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), null]), undefined]), explanation: faker.helpers.arrayElement([{upsideRetention: faker.string.alpha({length: {min: 10, max: 20}}), downsideProtection: faker.string.alpha({length: {min: 10, max: 20}}), carryTheta: faker.string.alpha({length: {min: 10, max: 20}}), residualExposure: faker.string.alpha({length: {min: 10, max: 20}})}, undefined])})), ...overrideResponse})
...
export const getTestProviderConnectionMockHandler = (overrideResponse?: ProviderTestResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ProviderTestResponse> | ProviderTestResponse), options?: RequestHandlerOptions) => {
  return http.post('*/providers/test', async (info) => {await delay(150);
  
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getTestProviderConnectionResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getDefaultMock = () => [
  ...
  getTestProviderConnectionMockHandler(),
